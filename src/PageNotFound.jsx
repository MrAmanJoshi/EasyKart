...
function PageNotFound(){
  return (
    <div className="p-5  flex bg-white sm-w-full rounded-xl justify-center mx-auto  h-screen">
 ...
 <p className=" shrink-0  text-3xl font-bold text-indigo-800 drop-shadow-md	 ">O o P s... </p>
      ...
      <div className="flex justify-end">
        <Link to="/" className="px-2 hover:bg-green-400 py-1 bg-yellow-400  drop-shadow-md	ring-2 hover:ring-yellow-400 
